...
-- Binding Header (required by WoW to show binding names in Key Bindings UI)
BINDING_HEADER_OMNIINVENTORY = "OmniInventory"
BINDING_NAME_OMNIINVENTORY_TOGGLE = "Toggle Bags"
BINDING_NAME_OMNIINVENTORY_OPEN = "Open Bags"
BINDING_NAME_OMNIINVENTORY_CLOSE = "Close Bags"
BINDING_NAME_OMNIINVENTORY_TOGGLE_BANK = "Toggle Bank"
BINDING_NAME_OMNI_AUTODESTROY_PROCESS = "Process Destroy Queue"
